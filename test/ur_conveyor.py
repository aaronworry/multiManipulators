...
ur1 = p.loadURDF("../model/ur/ur5e.urdf", [1., 0.6, 0.2], useFixedBase = 1)
ur2 = p.loadURDF("../model/ur/ur5e.urdf", [1., -0.6, 0.2], useFixedBase = 1)
ur3 = p.loadURDF("../model/ur/ur5e.urdf", [-1., 0.6, 0.2], useFixedBase = 1)
ur4 = p.loadURDF("../model/ur/ur5e.urdf", [-1., -0.6, 0.2], useFixedBase = 1)


blue_cube = p.loadURDF("../model/conveyor/blue_cube.urdf", [0, -1., 0.2], useFixedBase = 0)
